...
describe('CoverComparison', async () => {
  it('should render the cover comparison', async ({ expect }) => {
    const { container } = render(CoverComparison, { props: { cover: mockCover } });
  ...
  it('should render links to listen to original and cover', async ({ expect }) => {
    const { container } = render(CoverComparison, { props: { cover: mockCover } });
  ...
  it('should render "covered as" when the titles differ', async ({ expect }) => {
    const { container } = render(CoverComparison, { props: { cover: mockCover } });
